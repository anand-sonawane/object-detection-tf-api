...
def main(_):
  ...
  create_tf_record(train_output_path, label_map_dict, annotations_dir,image_dir, train_list)
  create_tf_record(val_output_path, label_map_dict, annotations_dir,image_dir,valid_list)
